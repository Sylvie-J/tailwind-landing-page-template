        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h1 className="h1">Welcome to Jengo </h1>
              <span className=" text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">What would you like to build?</span>
            </div>
